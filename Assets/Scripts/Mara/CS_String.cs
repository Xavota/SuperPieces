...
public class CS_String : MonoBehaviour
{
  ...
  float mCurrentLenght = 0.0f;
  public float RopeLenght
  {
    get
    {
      return mCurrentLenght;
    }
  }
  float mRealCurrentLenght = 0.0f;
  public float RopeRealLenght
  {
    get
    {
      return mRealCurrentLenght;
    }
  }
  ...
  List<Vector3> mStringPoints = new List<Vector3>();
  public List<Vector3> Points
  {
    get
    {
      return mStringPoints;
    }
  }
